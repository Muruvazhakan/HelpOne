...
return(
    <View style={{flex:1}}>
                    ...
                    <View style={styles.userInfoSection}>
                        <View style={{flexDirection:'row',marginTop: 15}}>
                            ...
                            <View style={{marginLeft:15, flexDirection:'column'}}>
                                <Title style={styles.title}>Mur</Title>
                                <Caption style={styles.caption}>Murupu@gmail</Caption>
                            </View>        
                        </View>
                        ...
                        <View style={styles.row}>
                            <View style={styles.section}>
                                ...
                                <Caption style={styles.caption}>Blood Donated</Caption>
                            </View>
                            <View style={styles.section}>
        ...
        <RetriveData userData={props.userdetails} />
    </View>
);
