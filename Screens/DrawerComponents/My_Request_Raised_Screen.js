...
import {
  View, Button,
  StyleSheet, FlatList, SafeAreaView, ActivityIndicator, Alert,ToastAndroid
} from 'react-native';
...
const My_Request_Raised_Screen = ({ navigation }) => {
...
var offline = 0;
  ...
  const onRetrivemydonateddata = async () => {
	let API_URL = `${Server_URL}/my_blood_request_raised.php`;
    //let API_URL = 'http://192.168.0.9/help_1/my_blood_request_raised.php';
    ...
    fetch(API_URL, {
      ...
      if (res == "No") {
        ...
        console.log("retriveserverdata before" + setupretrivedata);
        setState({
          ...state,
          checkserverdata: false,
  ...
  const handlepress = (item) => {
    ...
    navigation.navigate('My_Request_Display', {
                  ...
                  >
                    ...
                    <View style={[ProfileScreenStyles.cardview, {
                      ...
                      <View style={[ProfileScreenStyles.row, { margin: '1%', marginLeft: '5%' }]}>
                        ...
                        <Text style={{ marginLeft: '3%' }}>Number: {item.patientname}</Text>
                      </View>
                      <View style={[ProfileScreenStyles.row, { margin: '1%', marginLeft: '5%' }]}>
...
export default My_Request_Raised_Screen;
